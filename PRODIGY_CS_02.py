...
class ImageEncryptDecrypt:
    def __init__(self, root):
        ...
        # Widgets
        self.label_input = tk.Label(root, text="Upload Image:")
        ...
        self.label_output_encrypted = tk.Label(root, text="Encrypted Image To Be Saved At:")
        ...
        self.label_output_decrypted = tk.Label(root, text="Decrypted Image To Be Saved At:")
